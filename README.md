...
**Success:** `200 OK` with `Result<TenantResponseDto>` — `apiKey` is **generated by the server** (save it; shown once at registration).
...
- [ ] JWT authentication for tenant admin & super-admin panels
