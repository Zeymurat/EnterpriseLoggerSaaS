...
using EnterpriseLogger.Infrastructure.Audit;
using EnterpriseLogger.Infrastructure.Auth;
using EnterpriseLogger.Infrastructure.Packages;
...
builder.Services.AddScoped<ITenantPackageQuotaProvider, DbTenantPackageQuotaProvider>();
...
builder.Services.AddSingleton<IImpersonationTicketStore, MemoryImpersonationTicketStore>();
...
builder.Services.AddBilling(builder.Environment);
builder.Services.AddEmailNotifications();
builder.Services.AddBackgroundJobs(builder.Environment);
...
builder.Services.AddScoped<ConsumeImpersonationTicketCommand>();
...
builder.Services.AddScoped<DeletePlatformTenantCommand>();
builder.Services.AddScoped<LinkSubscriptionPaymentCommand>();
builder.Services.AddScoped<CancelTenantSubscriptionCommand>();
builder.Services.AddScoped<RemoveTenantSubscriptionCommand>();
builder.Services.AddScoped<SetTenantStatusCommand>();
builder.Services.AddScoped<ResetTenantRootPasswordCommand>();
builder.Services.AddScoped<GetPlatformPackagesQuery>();
builder.Services.AddScoped<UpdatePlatformPackageCommand>();
builder.Services.AddScoped<CreatePlatformPackageCommand>();
builder.Services.AddScoped<DeletePlatformPackageCommand>();
builder.Services.AddScoped<GetPlatformPaymentsQuery>();
builder.Services.AddScoped<GetTenantAvailablePaymentsQuery>();
builder.Services.AddScoped<GetTenantPaymentsQuery>();
builder.Services.AddScoped<RecordPlatformPaymentCommand>();
builder.Services.AddScoped<ConfirmPlatformPaymentCommand>();
builder.Services.AddScoped<RejectPlatformPaymentCommand>();
...
builder.Services.AddScoped<GetTenantBillingOverviewQuery>();
builder.Services.AddScoped<GetPlatformDashboardQuery>();
builder.Services.AddScoped<GetPlatformRenewalsQuery>();
builder.Services.AddScoped<GetPlatformAuditLogsQuery>();
